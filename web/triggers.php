...
<?php
$result = doQuery("SELECT ID,Event,Action,Args,isEnable FROM Triggers WHERE userId='$mySession->userId' ORDER BY addDate DESC LIMIT 20 ;");
if(mysqli_num_rows($result) > 0) {
	...
	echo "<tr>
	    ...
	    <td>$trigger_args</td>
	    <td><a class='btn btn-secondary ajaxDialog' href='/ajax?action=trigger_edit&id=$trigger_id' title='Edit trigger'><i class='fa fa-pencil' aria-hidden='true'></i></a></td>
	</tr>";
    }
} else {
